...
class CodeGenerators:
    ...
    def gen_print_result(self):
        ...
        for layer in self.model_sw.layers :
            ...
            o1 = open("cpp_generator/mobilenetv2/Template/Print/Print_Output3D.txt")
    ...
    def gen_initialization(self):
        ...
        for layer in self.model_sw.layers:
            ...
            if layer_type == 'InputLayer':
                i_input = open("cpp_generator/mobilenetv2/Template/Init/Input_var_Initializer_f.txt")
                ...
                c_input = open("cpp_generator/mobilenetv2/Template/Init/Conv_var_Initializer_f.txt")
                ...
                filter_shape = eval(layer.config['kernel_size'])
                dc_input = open("cpp_generator/mobilenetv2/Template/Init/depthConv_var_Initializer_f.txt")
                ...
                b_input = open("cpp_generator/mobilenetv2/Template/Init/Batch_var_Initializer_f.txt")
