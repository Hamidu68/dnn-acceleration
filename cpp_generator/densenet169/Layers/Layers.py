...
class MaxPooling2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        mxp = open("cpp_generator/densenet169/Template/Function/MaxPooling2D.txt")
        template = mxp.read()
...
class BatchNormalization(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        if self.config['scale'] == 'False' :
            batch_normal = open("cpp_generator/densenet169/Template/Function/BatchNormalization_no_scale.txt")
        else :
            batch_normal = open("cpp_generator/densenet169/Template/Function/BatchNormalization.txt")
...
class Activation(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        if self.config['activation'] == 'relu':
            rl = open("cpp_generator/densenet169/Template/Function/Activation_relu.txt")
            template = rl.read()
            ...
            rl = open("cpp_generator/densenet169/Template/Function/Activation_softmax.txt")
            template = rl.read()
...
class AveragePooling2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        avp = open("cpp_generator/densenet169/Template/Function/AveragePooling2D.txt")
        template = avp.read()
        func = template.format(Name=self.config["name"], Input_channel=input_shape[3], Input_width=input_shape[1],
                               Input_height=input_shape[2], Output_channel=output_shape[3], Output_width=output_shape[1],
...
class ZeroPadding2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        zp = open("cpp_generator/densenet169/Template/Function/ZeroPadding.txt")
        template = zp.read()
        func = template.format(Name=self.config["name"], Input_channel=input_shape[3], Input_width=input_shape[1],
                               Input_height=input_shape[2], Output_channel=output_shape[3], Output_width=output_shape[1],
...
class Dense(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        if use_bias:
            den_s = open("cpp_generator/densenet169/Template/Function/Dense_Softmax_bias.txt")
            den_r = open("cpp_generator/densenet169/Template/Function/Dense_Relu_bias.txt")
            dense_softmax = den_s.read()
            dense_relu = den_r.read()
        else:
            den_s = open("cpp_generator/densenet169/Template/Function/Dense_Softmax.txt")
            den_r = open("cpp_generator/densenet169/Template/Function/Dense_Relu.txt")
            dense_softmax = den_s.read()
            dense_relu = den_r.read()
...
class Concatenate(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        con2 = open("cpp_generator/densenet169/Template/Function/Concatenate2.txt")
        con2_r = con2.read()
...
class GlobalAveragePooling2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        mxp = open("cpp_generator/densenet169/Template/Function/GlobalAveragePooling2D.txt")
        template = mxp.read()
        func = template.format(Name=self.config["name"], Input_channel=input_shape[3], Input_width=input_shape[1],
