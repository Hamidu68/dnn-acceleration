...
class CodeGenerators:
    ...
    def gen_print_result(self):
        ...
        for layer in self.model_sw.layers :
            ...
            o1 = open("cpp_generator/densenet121/Template/Print/Print_Output3D.txt")
            o2 = open("cpp_generator/densenet121/Template/Print/Print_Output1D.txt")
            output3d = o1.read()
            output1d = o2.read()
    ...
    def gen_initialization(self):
        ...
        for layer in self.model_sw.layers:
            ...
            if layer_type == 'InputLayer':
                i_input = open("cpp_generator/densenet121/Template/Init/Input_var_Initializer_f.txt")
                ...
                c_input = open("cpp_generator/densenet121/Template/Init/Conv_var_Initializer_f.txt")
                ...
                d_input = open("cpp_generator/densenet121/Template/Init/Dense_var_Initializer_f.txt")
                ...
                b_input = open("cpp_generator/densenet121/Template/Init/Batch_var_Initializer_f.txt")
