...
class C_verifier(CodeGenerators):
    ...
    def generate(self):
        file = open('C_verifier_code/nasnetmobile/C_verifier.cpp', 'w')
...
int main(int argc, char *argv[]){{
    ...
    FILE *o_stream = fopen("../../cpp_generator/nasnetmobile/Output/C_output.txt", "w");
    if (o_stream == NULL) printf("Output file was not opened");
    FILE *c_num = fopen("../../cpp_generator/nasnetmobile/Output/c_output_num.txt", "w");
