...
class MaxPooling2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        mxp = open("cpp_generator/nasnetmobile/Template/Function/MaxPooling2D.txt")
        template = mxp.read()
...
class BatchNormalization(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        if self.config['scale'] == 'False' :
            batch_normal = open("cpp_generator/nasnetmobile/Template/Function/BatchNormalization_no_scale.txt")
        else :
            batch_normal = open("cpp_generator/nasnetmobile/Template/Function/BatchNormalization.txt")
...
class Activation(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        if self.config['activation'] == 'relu':
            rl = open("cpp_generator/nasnetmobile/Template/Function/Activation_relu.txt")
            template = rl.read()
            ...
            rl = open("cpp_generator/nasnetmobile/Template/Function/Activation_softmax.txt")
            template = rl.read()
...
class AveragePooling2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        avp = open("cpp_generator/nasnetmobile/Template/Function/AveragePooling2D.txt")
        template = avp.read()
        func = template.format(Name=self.config["name"], Input_channel=input_shape[3], Input_width=input_shape[1],
                               Input_height=input_shape[2], Output_channel=output_shape[3], Output_width=output_shape[1],
...
class ZeroPadding2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        zp = open("cpp_generator/nasnetmobile/Template/Function/ZeroPadding.txt")
        template = zp.read()
        func = template.format(Name=self.config["name"], Input_channel=input_shape[3], Input_width=input_shape[1],
                               Input_height=input_shape[2], Output_channel=output_shape[3], Output_width=output_shape[1],
...
class Flatten(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        fla = open("cpp_generator/nasnetmobile/Template/Function/Flatten.txt")
        template = fla.read()
        func = template.format(Name=self.config["name"], Input_channel=input_shape[3], Input_width=input_shape[1],
...
class Dense(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        if use_bias:
            den_s = open("cpp_generator/nasnetmobile/Template/Function/Dense_Softmax_bias.txt")
            den_r = open("cpp_generator/nasnetmobile/Template/Function/Dense_Relu_bias.txt")
            dense_softmax = den_s.read()
            dense_relu = den_r.read()
        else:
            den_s = open("cpp_generator/nasnetmobile/Template/Function/Dense_Softmax.txt")
            den_r = open("cpp_generator/nasnetmobile/Template/Function/Dense_Relu.txt")
            dense_softmax = den_s.read()
            dense_relu = den_r.read()
...
class Add(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        ad = open("cpp_generator/nasnetmobile/Template/Function/Add.txt")
        template = ad.read()
...
class Concatenate(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        con3 = open("cpp_generator/nasnetmobile/Template/Function/Concatenate3.txt")
        con4 = open("cpp_generator/nasnetmobile/Template/Function/Concatenate4.txt")
        con3_r = con3.read()
        con4_r = con4.read()
...
class GlobalAveragePooling2D(Layers):
    ...
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        mxp = open("cpp_generator/nasnetmobile/Template/Function/GlobalAveragePooling2D.txt")
        template = mxp.read()
        func = template.format(Name=self.config["name"], Input_channel=input_shape[3], Input_width=input_shape[1],
...
class SeparableConv2D(Layers):
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        sepconv = open("cpp_generator/nasnetmobile/Template/Function/SeparableConv2D.txt")
...
class Cropping2D(Layers):
    def __init__(self, config={}, inputs=[], dtype='DATA_T', layer_odr=0, post=''):
        ...
        # code
        cropp = open("cpp_generator/nasnetmobile/Template/Function/Cropping2D.txt")
        cropp_2d = cropp.read()
