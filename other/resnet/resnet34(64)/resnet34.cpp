...
#pragma HLS ARRAY_PARTITION variable=I complete dim=1
	Stream_input_x_loop: for (x=0; x<64; x++) {
	 	Stream_input_y_loop: for (y=0; y<64; y++) {
#pragma HLS PIPELINE
...
void Stream_output(hls::stream<DATA_T> &O_strm, DATA_T O[200]) {
  int x;
#pragma HLS ARRAY_PARTITION variable=O complete dim=1

	Stream_input_x_loop: for (x=0; x<200; x++) {
...
static DATA_T I_i[3][64][64];
	...
	static DATA_T W88_i[200][512];
	static DATA_T B88_i[200];
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_1_x_loop: for (x = 0; x<64 + 1; x++) {
		HW_conv2d_1_y_loop: for (y = 0; y<64 + 1 ; y++) {
			HW_conv2d_1_k_loop: for (k = 0; k<3; k++) {
			    if(x < 64 && y < 64){
	                I[k][x % 3][y] = I_strm.read();}
				if (x && y){
#pragma HLS PIPELINE
					if (x - 2 + 0 < 64 && y - 2 + 0 < 64 && x - 2 + 0 >= 0 && y - 2 + 0 >= 0) {
						I_0 = I[k][(x - 2) % 3][(y - 2)];
					}
					else {
						I_0 = 0; // zero padding
					}
					if (x - 2 + 0 < 64 && y - 2 + 1 < 64 && x - 2 + 0 >= 0 && y - 2 + 1 >= 0) {
						I_1 = I[k][(x - 2) % 3][(y - 1)];
					}
					else {
						I_1 = 0; // zero padding
					}
					if (x - 2 + 0 < 64 && y - 2 + 2 < 64 && x - 2 + 0 >= 0 && y - 2 + 2 >= 0) {
						I_2 = I[k][(x - 2) % 3][(y)];
					}
					else {
						I_2 = 0; // zero padding
					...
					if (x - 2 + 1 < 64 && y - 2 + 0 < 64 && x - 2 + 1 >= 0 && y - 2 + 0 >= 0) {
						I_3 = I[k][(x - 1) % 3][(y - 2)];
					}
					else {
						I_3 = 0; // zero padding
					}
					if (x - 2 + 1 < 64 && y - 2 + 1 < 64 && x - 2 + 1 >= 0 && y - 2 + 1 >= 0) {
						I_4 = I[k][(x - 1) % 3][(y - 1)];
					}
					else {
						I_4 = 0; // zero padding
					}
					if (x - 2 + 1 < 64 && y - 2 + 2 < 64 && x - 2 + 1 >= 0 && y - 2 + 2 >= 0) {
						I_5 = I[k][(x - 1) % 3][(y)];
					}
					else {
						I_5 = 0; // zero padding
					}
					if (x - 2 + 2 < 64 && y - 2 + 0 < 64 && x - 2 + 2 >= 0 && y - 2 + 0 >= 0) {
						I_6 = I[k][(x) % 3][(y - 2)];
					}
					else {
						I_6 = 0; // zero padding
					}
					if (x - 2 + 2 < 64 && y - 2 + 1 < 64 && x - 2 + 2 >= 0 && y - 2 + 1 >= 0) {
						I_7 = I[k][(x) % 3][(y - 1)];
					}
					else {
						I_7 = 0; // zero padding
					}
					if (x - 2 + 2 < 64 && y - 2 + 2 < 64 && x - 2 + 2 >= 0 && y - 2 + 2 >= 0) {
						I_8 = I[k][(x) % 3][(y)];
					}
					else {
						I_8 = 0; // zero padding
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_1_x_loop: for (x = 0; x < 64; x++) {
		HW_activation_1_y_loop: for (y = 0; y < 64; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_res0a_branch2a_x_loop: for (x = 0; x<64 + 1 ; x++) {
		HW_res0a_branch2a_y_loop: for (y = 0; y<64 + 1 ; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_2_x_loop: for (x = 0; x<32 + 1; x++) {
		HW_conv2d_2_y_loop: for (y = 0; y<32 + 1 ; y++) {
...
#pragma HLS ARRAY_PARTITION variable=ofm complete dim=0
	...
	HW_conv2d_3_x_loop: for (x = 0; x < 64; x++) {
		HW_conv2d_3_y_loop: for (y = 0; y < 64; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_2_x_loop: for (x = 0; x < 32; x++) {
		HW_activation_2_y_loop: for (y = 0; y < 32; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_1_x_loop_1: for (x = 0; x < 32; x++) {
	    HW_add_1_y_loop_1: for (y = 0; y < 32; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_4_x_loop: for (x = 0; x<32 + 1; x++) {
		HW_conv2d_4_y_loop: for (y = 0; y<32 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_3_x_loop: for (x = 0; x < 32; x++) {
		HW_activation_3_y_loop: for (y = 0; y < 32; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_5_x_loop: for (x = 0; x<32 + 1; x++) {
		HW_conv2d_5_y_loop: for (y = 0; y<32 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_4_x_loop: for (x = 0; x < 32; x++) {
		HW_activation_4_y_loop: for (y = 0; y < 32; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_2_x_loop_1: for (x = 0; x < 32; x++) {
	    HW_add_2_y_loop_1: for (y = 0; y < 32; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_6_x_loop: for (x = 0; x<32 + 1; x++) {
		HW_conv2d_6_y_loop: for (y = 0; y<32 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_5_x_loop: for (x = 0; x < 32; x++) {
		HW_activation_5_y_loop: for (y = 0; y < 32; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_7_x_loop: for (x = 0; x<32 + 1; x++) {
		HW_conv2d_7_y_loop: for (y = 0; y<32 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_6_x_loop: for (x = 0; x < 32; x++) {
		HW_activation_6_y_loop: for (y = 0; y < 32; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_3_x_loop_1: for (x = 0; x < 32; x++) {
	    HW_add_3_y_loop_1: for (y = 0; y < 32; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_8_x_loop: for (x = 0; x<32 + 1 ; x++) {
		HW_conv2d_8_y_loop: for (y = 0; y<32 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_7_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_7_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_9_x_loop: for (x = 0; x<16 + 1; x++) {
		HW_conv2d_9_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS ARRAY_PARTITION variable=ofm complete dim=0
	...
	HW_conv2d_10_x_loop: for (x = 0; x < 32; x++) {
		HW_conv2d_10_y_loop: for (y = 0; y < 32; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_8_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_8_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_4_x_loop_1: for (x = 0; x < 16; x++) {
	    HW_add_4_y_loop_1: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_11_x_loop: for (x = 0; x<16 + 1; x++) {
		HW_conv2d_11_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_9_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_9_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_12_x_loop: for (x = 0; x<16 + 1; x++) {
		HW_conv2d_12_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_10_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_10_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_5_x_loop_1: for (x = 0; x < 16; x++) {
	    HW_add_5_y_loop_1: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_13_x_loop: for (x = 0; x<16 + 1; x++) {
		HW_conv2d_13_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_11_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_11_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_14_x_loop: for (x = 0; x<16 + 1; x++) {
		HW_conv2d_14_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_12_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_12_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_6_x_loop_1: for (x = 0; x < 16; x++) {
	    HW_add_6_y_loop_1: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_15_x_loop: for (x = 0; x<16 + 1; x++) {
		HW_conv2d_15_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_13_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_13_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_16_x_loop: for (x = 0; x<16 + 1; x++) {
		HW_conv2d_16_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_14_x_loop: for (x = 0; x < 16; x++) {
		HW_activation_14_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_7_x_loop_1: for (x = 0; x < 16; x++) {
	    HW_add_7_y_loop_1: for (y = 0; y < 16; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_17_x_loop: for (x = 0; x<16 + 1 ; x++) {
		HW_conv2d_17_y_loop: for (y = 0; y<16 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_15_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_15_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_18_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_18_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS ARRAY_PARTITION variable=ofm complete dim=0
	...
	HW_conv2d_19_x_loop: for (x = 0; x < 16; x++) {
		HW_conv2d_19_y_loop: for (y = 0; y < 16; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_16_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_16_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_8_x_loop_1: for (x = 0; x < 8; x++) {
	    HW_add_8_y_loop_1: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_20_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_20_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_17_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_17_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_21_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_21_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_18_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_18_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_9_x_loop_1: for (x = 0; x < 8; x++) {
	    HW_add_9_y_loop_1: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_22_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_22_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_19_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_19_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_23_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_23_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_20_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_20_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_10_x_loop_1: for (x = 0; x < 8; x++) {
	    HW_add_10_y_loop_1: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_24_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_24_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_21_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_21_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_25_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_25_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_22_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_22_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_11_x_loop_1: for (x = 0; x < 8; x++) {
	    HW_add_11_y_loop_1: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_26_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_26_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_23_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_23_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_27_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_27_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_24_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_24_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_12_x_loop_1: for (x = 0; x < 8; x++) {
	    HW_add_12_y_loop_1: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_28_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_28_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_25_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_25_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_29_x_loop: for (x = 0; x<8 + 1; x++) {
		HW_conv2d_29_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_26_x_loop: for (x = 0; x < 8; x++) {
		HW_activation_26_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_13_x_loop_1: for (x = 0; x < 8; x++) {
	    HW_add_13_y_loop_1: for (y = 0; y < 8; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_30_x_loop: for (x = 0; x<8 + 1 ; x++) {
		HW_conv2d_30_y_loop: for (y = 0; y<8 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_27_x_loop: for (x = 0; x < 4; x++) {
		HW_activation_27_y_loop: for (y = 0; y < 4; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_31_x_loop: for (x = 0; x<4 + 1; x++) {
		HW_conv2d_31_y_loop: for (y = 0; y<4 + 1 ; y++) {
...
#pragma HLS ARRAY_PARTITION variable=ofm complete dim=0
	...
	HW_conv2d_32_x_loop: for (x = 0; x < 8; x++) {
		HW_conv2d_32_y_loop: for (y = 0; y < 8; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_28_x_loop: for (x = 0; x < 4; x++) {
		HW_activation_28_y_loop: for (y = 0; y < 4; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_14_x_loop_1: for (x = 0; x < 4; x++) {
	    HW_add_14_y_loop_1: for (y = 0; y < 4; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_33_x_loop: for (x = 0; x<4 + 1; x++) {
		HW_conv2d_33_y_loop: for (y = 0; y<4 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_29_x_loop: for (x = 0; x < 4; x++) {
		HW_activation_29_y_loop: for (y = 0; y < 4; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_34_x_loop: for (x = 0; x<4 + 1; x++) {
		HW_conv2d_34_y_loop: for (y = 0; y<4 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_30_x_loop: for (x = 0; x < 4; x++) {
		HW_activation_30_y_loop: for (y = 0; y < 4; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_15_x_loop_1: for (x = 0; x < 4; x++) {
	    HW_add_15_y_loop_1: for (y = 0; y < 4; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_35_x_loop: for (x = 0; x<4 + 1; x++) {
		HW_conv2d_35_y_loop: for (y = 0; y<4 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_31_x_loop: for (x = 0; x < 4; x++) {
		HW_activation_31_y_loop: for (y = 0; y < 4; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3
	...
	HW_conv2d_36_x_loop: for (x = 0; x<4 + 1; x++) {
		HW_conv2d_36_y_loop: for (y = 0; y<4 + 1 ; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_32_x_loop: for (x = 0; x < 4; x++) {
		HW_activation_32_y_loop: for (y = 0; y < 4; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_add_16_x_loop_1: for (x = 0; x < 4; x++) {
	    HW_add_16_y_loop_1: for (y = 0; y < 4; y++) {
...
#pragma HLS INLINE
	int m, x, y;
	DATA_T ifm;
	HW_activation_33_x_loop: for (x = 0; x < 4; x++) {
		HW_activation_33_y_loop: for (y = 0; y < 4; y++) {
...
#pragma HLS INLINE
  ...
  HW_global_average_pooling2d_1_x_loop: for (x=0; x<4; x++) {
	  HW_global_average_pooling2d_1_y_loop: for (y=0; y<4; y++) {
...
void HW_dense_1(hls::stream<DATA_T> &I_strm, DATA_T W[200][512],DATA_T B[200],hls::stream<DATA_T> &O_strm) {
#pragma HLS INLINE
	int m, c;
	DATA_T maximum;
	DATA_T ofm[200];
	...
	HW_dense_1_c_loop: for (c = 0; c < 512; c++){
	    ifm = I_strm.read();
		HW_dense_1_m_1_loop: for (m=0; m<200; m++) {
#pragma HLS PIPELINE
		  if(c == 0)
		    ofm[m] = B[m];
		  ofm[m] += W[m][c] * ifm;
    ...
    //find Max
    maximum = ofm[0];
    HW_dense_1_m_2_loop: for (m = 1; m < 200; m++){
		if(maximum<ofm[m])
		   maximum=ofm[m];
    }
    //one hot label
    HW_dense_1_m_3_loop: for (m = 0; m < 200; m++){
	    if(maximum!=ofm[m])
	        O_strm.write(0);
	    else
	        O_strm.write(1);
...
void SW_conv2d_1(DATA_T I[3][64][64], DATA_T O[64][64][64], DATA_T W[64][3][3][3], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<64; x++) {
			for (y = 0; y<64; y++) {
				...
				for (k = 0; k<3; k++) {
					for (i = 0; i<3; i++) {
						for (j = 0; j<3; j++) {
							if (x*1 + i < 64 + 1 && y*1 + j < 64 + 1 && x*1 + i -1 >= 0 && y*1 + j -1 >= 0) {
...
void SW_activation_1(DATA_T I[64][64][64], DATA_T O[64][64][64]) {
	int m, x, y, i, j, k;
	for (m = 0; m<64; m++) {
		for (x = 0; x<64; x++) {
			for (y = 0; y<64; y++) {
...
void SW_res0a_branch2a(DATA_T I[64][64][64], DATA_T O[64][32][32], DATA_T W[64][64][3][3], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
			for (y = 0; y<32; y++) {
				...
				for (k = 0; k<64; k++) {
					for (i = 0; i<3; i++) {
						for (j = 0; j<3; j++) {
							if (x*2 + i < 64 + 0 && y*2 + j < 64 + 0 && x*2 + i -0 >= 0 && y*2 + j -0 >= 0) {
...
void SW_conv2d_2(DATA_T I[64][32][32], DATA_T O[64][32][32], DATA_T W[64][64][3][3], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
...
void SW_conv2d_3(DATA_T I[64][64][64], DATA_T O[64][32][32], DATA_T W[64][64][1][1], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
...
void SW_activation_2(DATA_T I[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y, i, j, k;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
			for (y = 0; y<32; y++) {
...
void SW_add_1(DATA_T I1[64][32][32], DATA_T I2[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y;
	for (m = 0; m< 64; m++) {
		for (x = 0; x < 32; x++) {
			for(y = 0; y < 32; y++) {
...
void SW_conv2d_4(DATA_T I[64][32][32], DATA_T O[64][32][32], DATA_T W[64][64][3][3], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
...
void SW_activation_3(DATA_T I[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y, i, j, k;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
			for (y = 0; y<32; y++) {
...
void SW_conv2d_5(DATA_T I[64][32][32], DATA_T O[64][32][32], DATA_T W[64][64][3][3], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
...
void SW_activation_4(DATA_T I[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y, i, j, k;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
			for (y = 0; y<32; y++) {
...
void SW_add_2(DATA_T I1[64][32][32], DATA_T I2[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y;
	for (m = 0; m< 64; m++) {
		for (x = 0; x < 32; x++) {
			for(y = 0; y < 32; y++) {
...
void SW_conv2d_6(DATA_T I[64][32][32], DATA_T O[64][32][32], DATA_T W[64][64][3][3], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
...
void SW_activation_5(DATA_T I[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y, i, j, k;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
			for (y = 0; y<32; y++) {
...
void SW_conv2d_7(DATA_T I[64][32][32], DATA_T O[64][32][32], DATA_T W[64][64][3][3], DATA_T B[64]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
...
void SW_activation_6(DATA_T I[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y, i, j, k;
	for (m = 0; m<64; m++) {
		for (x = 0; x<32; x++) {
			for (y = 0; y<32; y++) {
...
void SW_add_3(DATA_T I1[64][32][32], DATA_T I2[64][32][32], DATA_T O[64][32][32]) {
	int m, x, y;
	for (m = 0; m< 64; m++) {
		for (x = 0; x < 32; x++) {
			for(y = 0; y < 32; y++) {
...
void SW_conv2d_8(DATA_T I[64][32][32], DATA_T O[128][16][16], DATA_T W[128][64][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_7(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_conv2d_9(DATA_T I[128][16][16], DATA_T O[128][16][16], DATA_T W[128][128][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_conv2d_10(DATA_T I[64][32][32], DATA_T O[128][16][16], DATA_T W[128][64][1][1], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_8(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_add_4(DATA_T I1[128][16][16], DATA_T I2[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y;
	for (m = 0; m< 128; m++) {
		for (x = 0; x < 16; x++) {
			for(y = 0; y < 16; y++) {
...
void SW_conv2d_11(DATA_T I[128][16][16], DATA_T O[128][16][16], DATA_T W[128][128][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_9(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_conv2d_12(DATA_T I[128][16][16], DATA_T O[128][16][16], DATA_T W[128][128][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_10(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_add_5(DATA_T I1[128][16][16], DATA_T I2[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y;
	for (m = 0; m< 128; m++) {
		for (x = 0; x < 16; x++) {
			for(y = 0; y < 16; y++) {
...
void SW_conv2d_13(DATA_T I[128][16][16], DATA_T O[128][16][16], DATA_T W[128][128][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_11(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_conv2d_14(DATA_T I[128][16][16], DATA_T O[128][16][16], DATA_T W[128][128][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_12(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_add_6(DATA_T I1[128][16][16], DATA_T I2[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y;
	for (m = 0; m< 128; m++) {
		for (x = 0; x < 16; x++) {
			for(y = 0; y < 16; y++) {
...
void SW_conv2d_15(DATA_T I[128][16][16], DATA_T O[128][16][16], DATA_T W[128][128][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_13(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_conv2d_16(DATA_T I[128][16][16], DATA_T O[128][16][16], DATA_T W[128][128][3][3], DATA_T B[128]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
...
void SW_activation_14(DATA_T I[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y, i, j, k;
	for (m = 0; m<128; m++) {
		for (x = 0; x<16; x++) {
			for (y = 0; y<16; y++) {
...
void SW_add_7(DATA_T I1[128][16][16], DATA_T I2[128][16][16], DATA_T O[128][16][16]) {
	int m, x, y;
	for (m = 0; m< 128; m++) {
		for (x = 0; x < 16; x++) {
			for(y = 0; y < 16; y++) {
...
void SW_conv2d_17(DATA_T I[128][16][16], DATA_T O[256][8][8], DATA_T W[256][128][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_15(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_conv2d_18(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_conv2d_19(DATA_T I[128][16][16], DATA_T O[256][8][8], DATA_T W[256][128][1][1], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_16(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_add_8(DATA_T I1[256][8][8], DATA_T I2[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y;
	for (m = 0; m< 256; m++) {
		for (x = 0; x < 8; x++) {
			for(y = 0; y < 8; y++) {
...
void SW_conv2d_20(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_17(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_conv2d_21(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_18(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_add_9(DATA_T I1[256][8][8], DATA_T I2[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y;
	for (m = 0; m< 256; m++) {
		for (x = 0; x < 8; x++) {
			for(y = 0; y < 8; y++) {
...
void SW_conv2d_22(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_19(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_conv2d_23(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_20(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_add_10(DATA_T I1[256][8][8], DATA_T I2[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y;
	for (m = 0; m< 256; m++) {
		for (x = 0; x < 8; x++) {
			for(y = 0; y < 8; y++) {
...
void SW_conv2d_24(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_21(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_conv2d_25(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_22(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_add_11(DATA_T I1[256][8][8], DATA_T I2[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y;
	for (m = 0; m< 256; m++) {
		for (x = 0; x < 8; x++) {
			for(y = 0; y < 8; y++) {
...
void SW_conv2d_26(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_23(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_conv2d_27(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_24(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_add_12(DATA_T I1[256][8][8], DATA_T I2[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y;
	for (m = 0; m< 256; m++) {
		for (x = 0; x < 8; x++) {
			for(y = 0; y < 8; y++) {
...
void SW_conv2d_28(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_25(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_conv2d_29(DATA_T I[256][8][8], DATA_T O[256][8][8], DATA_T W[256][256][3][3], DATA_T B[256]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
...
void SW_activation_26(DATA_T I[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y, i, j, k;
	for (m = 0; m<256; m++) {
		for (x = 0; x<8; x++) {
			for (y = 0; y<8; y++) {
...
void SW_add_13(DATA_T I1[256][8][8], DATA_T I2[256][8][8], DATA_T O[256][8][8]) {
	int m, x, y;
	for (m = 0; m< 256; m++) {
		for (x = 0; x < 8; x++) {
			for(y = 0; y < 8; y++) {
...
void SW_conv2d_30(DATA_T I[256][8][8], DATA_T O[512][4][4], DATA_T W[512][256][3][3], DATA_T B[512]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
...
void SW_activation_27(DATA_T I[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y, i, j, k;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
			for (y = 0; y<4; y++) {
...
void SW_conv2d_31(DATA_T I[512][4][4], DATA_T O[512][4][4], DATA_T W[512][512][3][3], DATA_T B[512]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
...
void SW_conv2d_32(DATA_T I[256][8][8], DATA_T O[512][4][4], DATA_T W[512][256][1][1], DATA_T B[512]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
...
void SW_activation_28(DATA_T I[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y, i, j, k;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
			for (y = 0; y<4; y++) {
...
void SW_add_14(DATA_T I1[512][4][4], DATA_T I2[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y;
	for (m = 0; m< 512; m++) {
		for (x = 0; x < 4; x++) {
			for(y = 0; y < 4; y++) {
...
void SW_conv2d_33(DATA_T I[512][4][4], DATA_T O[512][4][4], DATA_T W[512][512][3][3], DATA_T B[512]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
...
void SW_activation_29(DATA_T I[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y, i, j, k;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
			for (y = 0; y<4; y++) {
...
void SW_conv2d_34(DATA_T I[512][4][4], DATA_T O[512][4][4], DATA_T W[512][512][3][3], DATA_T B[512]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
...
void SW_activation_30(DATA_T I[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y, i, j, k;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
			for (y = 0; y<4; y++) {
...
void SW_add_15(DATA_T I1[512][4][4], DATA_T I2[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y;
	for (m = 0; m< 512; m++) {
		for (x = 0; x < 4; x++) {
			for(y = 0; y < 4; y++) {
...
void SW_conv2d_35(DATA_T I[512][4][4], DATA_T O[512][4][4], DATA_T W[512][512][3][3], DATA_T B[512]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
...
void SW_activation_31(DATA_T I[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y, i, j, k;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
			for (y = 0; y<4; y++) {
...
void SW_conv2d_36(DATA_T I[512][4][4], DATA_T O[512][4][4], DATA_T W[512][512][3][3], DATA_T B[512]) {
	int m, x, y, i, j, k;
	DATA_T ifm, ofm;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
...
void SW_activation_32(DATA_T I[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y, i, j, k;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
			for (y = 0; y<4; y++) {
...
void SW_add_16(DATA_T I1[512][4][4], DATA_T I2[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y;
	for (m = 0; m< 512; m++) {
		for (x = 0; x < 4; x++) {
			for(y = 0; y < 4; y++) {
...
void SW_activation_33(DATA_T I[512][4][4], DATA_T O[512][4][4]) {
	int m, x, y, i, j, k;
	for (m = 0; m<512; m++) {
		for (x = 0; x<4; x++) {
			for (y = 0; y<4; y++) {
...
void SW_global_average_pooling2d_1(DATA_T I[512][4][4], DATA_T O[512]) {
	int m, x, y;
	DATA_T avg;
	int div = 4 * 4;
	for (m = 0; m < 512; m++){
...
void SW_dense_1(DATA_T I[512], DATA_T O[200], DATA_T W[200][512], DATA_T B[200])
{
    //Dense
	int m, c;
	DATA_T maximum = 0;
...
void resnet34_top(DATA_T I[3][64][64],DATA_T W1[64][3][3][3],DATA_T B1[64], DATA_T W3[64][64][3][3],DATA_T B3[64], DATA_T W4[64][64][3][3],DATA_T B4[64], DATA_T W5[64][64][1][1],DATA_T B5[64], DATA_T W8[64][64][3][3],DATA_T B8[64], DATA_T W10[64][64][3][3],DATA_T B10[64], DATA_T W13[64][64][3][3],DATA_T B13[64], DATA_T W15[64][64][3][3],DATA_T B15[64], DATA_T W18[128][64][3][3],DATA_T B18[128], DATA_T W20[128][128][3][3],DATA_T B20[128], DATA_T W21[128][64][1][1],DATA_T B21[128], DATA_T W24[128][128][3][3],DATA_T B24[128], DATA_T W26[128][128][3][3],DATA_T B26[128], DATA_T W29[128][128][3][3],DATA_T B29[128], DATA_T W31[128][128][3][3],DATA_T B31[128], DATA_T W34[128][128][3][3],DATA_T B34[128], DATA_T W36[128][128][3][3],DATA_T B36[128], DATA_T W39[256][128][3][3],DATA_T B39[256], DATA_T W41[256][256][3][3],DATA_T B41[256], DATA_T W42[256][128][1][1],DATA_T B42[256], DATA_T W45[256][256][3][3],DATA_T B45[256], DATA_T W47[256][256][3][3],DATA_T B47[256], DATA_T W50[256][256][3][3],DATA_T B50[256], DATA_T W52[256][256][3][3],DATA_T B52[256], DATA_T W55[256][256][3][3],DATA_T B55[256], DATA_T W57[256][256][3][3],DATA_T B57[256], DATA_T W60[256][256][3][3],DATA_T B60[256], DATA_T W62[256][256][3][3],DATA_T B62[256], DATA_T W65[256][256][3][3],DATA_T B65[256], DATA_T W67[256][256][3][3],DATA_T B67[256], DATA_T W70[512][256][3][3],DATA_T B70[512], DATA_T W72[512][512][3][3],DATA_T B72[512], DATA_T W73[512][256][1][1],DATA_T B73[512], DATA_T W76[512][512][3][3],DATA_T B76[512], DATA_T W78[512][512][3][3],DATA_T B78[512], DATA_T W81[512][512][3][3],DATA_T B81[512], DATA_T W83[512][512][3][3],DATA_T B83[512], DATA_T W88[200][512],DATA_T B88[200],  DATA_T O[200]) {
  ...
  I_i_x_loop: for (x=0; x<64; x++) {
  I_i_y_loop: for (y=0; y<64; y++) {
  I_i[k][x][y] = I[k][x][y];
    }
  }
}
...
W88_i_m_loop: for (m=0; m<200; m++) {
  W88_i_k_loop: for (k=0; k<512; k++) {
  W88_i[m][k] = W88[m][k];
      }
}
B88_i_m_loop: for (m=0; m<200; m++) {
	B88_i[m] = B88[m];
}
    ...
    resnet34(I_i, W1_i, B1_i, W3_i, B3_i, W4_i, B4_i, W5_i, B5_i, W8_i, B8_i, W10_i, B10_i, W13_i, B13_i, W15_i, B15_i, W18_i, B18_i, W20_i, B20_i, W21_i, B21_i, W24_i, B24_i, W26_i, B26_i, W29_i, B29_i, W31_i, B31_i, W34_i, B34_i, W36_i, B36_i, W39_i, B39_i, W41_i, B41_i, W42_i, B42_i, W45_i, B45_i, W47_i, B47_i, W50_i, B50_i, W52_i, B52_i, W55_i, B55_i, W57_i, B57_i, W60_i, B60_i, W62_i, B62_i, W65_i, B65_i, W67_i, B67_i, W70_i, B70_i, W72_i, B72_i, W73_i, B73_i, W76_i, B76_i, W78_i, B78_i, W81_i, B81_i, W83_i, B83_i, W88_i, B88_i,  O_i);
    	...
    	for(m=0; m<200; m++) { O[m] = O_i[m]; }

}

void resnet34_sw(DATA_T I[3][64][64],DATA_T W1[64][3][3][3],DATA_T B1[64], DATA_T W3[64][64][3][3],DATA_T B3[64], DATA_T W4[64][64][3][3],DATA_T B4[64], DATA_T W5[64][64][1][1],DATA_T B5[64], DATA_T W8[64][64][3][3],DATA_T B8[64], DATA_T W10[64][64][3][3],DATA_T B10[64], DATA_T W13[64][64][3][3],DATA_T B13[64], DATA_T W15[64][64][3][3],DATA_T B15[64], DATA_T W18[128][64][3][3],DATA_T B18[128], DATA_T W20[128][128][3][3],DATA_T B20[128], DATA_T W21[128][64][1][1],DATA_T B21[128], DATA_T W24[128][128][3][3],DATA_T B24[128], DATA_T W26[128][128][3][3],DATA_T B26[128], DATA_T W29[128][128][3][3],DATA_T B29[128], DATA_T W31[128][128][3][3],DATA_T B31[128], DATA_T W34[128][128][3][3],DATA_T B34[128], DATA_T W36[128][128][3][3],DATA_T B36[128], DATA_T W39[256][128][3][3],DATA_T B39[256], DATA_T W41[256][256][3][3],DATA_T B41[256], DATA_T W42[256][128][1][1],DATA_T B42[256], DATA_T W45[256][256][3][3],DATA_T B45[256], DATA_T W47[256][256][3][3],DATA_T B47[256], DATA_T W50[256][256][3][3],DATA_T B50[256], DATA_T W52[256][256][3][3],DATA_T B52[256], DATA_T W55[256][256][3][3],DATA_T B55[256], DATA_T W57[256][256][3][3],DATA_T B57[256], DATA_T W60[256][256][3][3],DATA_T B60[256], DATA_T W62[256][256][3][3],DATA_T B62[256], DATA_T W65[256][256][3][3],DATA_T B65[256], DATA_T W67[256][256][3][3],DATA_T B67[256], DATA_T W70[512][256][3][3],DATA_T B70[512], DATA_T W72[512][512][3][3],DATA_T B72[512], DATA_T W73[512][256][1][1],DATA_T B73[512], DATA_T W76[512][512][3][3],DATA_T B76[512], DATA_T W78[512][512][3][3],DATA_T B78[512], DATA_T W81[512][512][3][3],DATA_T B81[512], DATA_T W83[512][512][3][3],DATA_T B83[512], DATA_T W88[200][512],DATA_T B88[200],  DATA_T O88_SW[200]) {
    static DATA_T O1_SW[64][64][64];
	static DATA_T O2_SW[64][64][64];
	static DATA_T O3_SW[64][32][32];
	static DATA_T O4_SW[64][32][32];
	static DATA_T O5_SW[64][32][32];
	static DATA_T O6_SW[64][32][32];
	static DATA_T O7_SW[64][32][32];
	static DATA_T O8_SW[64][32][32];
	static DATA_T O9_SW[64][32][32];
	static DATA_T O10_SW[64][32][32];
	static DATA_T O11_SW[64][32][32];
	static DATA_T O12_SW[64][32][32];
	static DATA_T O13_SW[64][32][32];
	static DATA_T O14_SW[64][32][32];
	static DATA_T O15_SW[64][32][32];
	static DATA_T O16_SW[64][32][32];
	static DATA_T O17_SW[64][32][32];
	static DATA_T O18_SW[128][16][16];
	static DATA_T O19_SW[128][16][16];
	static DATA_T O20_SW[128][16][16];
	static DATA_T O21_SW[128][16][16];
	static DATA_T O22_SW[128][16][16];
	static DATA_T O23_SW[128][16][16];
	static DATA_T O24_SW[128][16][16];
	static DATA_T O25_SW[128][16][16];
	static DATA_T O26_SW[128][16][16];
	static DATA_T O27_SW[128][16][16];
	static DATA_T O28_SW[128][16][16];
	static DATA_T O29_SW[128][16][16];
	static DATA_T O30_SW[128][16][16];
	static DATA_T O31_SW[128][16][16];
	static DATA_T O32_SW[128][16][16];
	static DATA_T O33_SW[128][16][16];
	static DATA_T O34_SW[128][16][16];
	static DATA_T O35_SW[128][16][16];
	static DATA_T O36_SW[128][16][16];
	static DATA_T O37_SW[128][16][16];
	static DATA_T O38_SW[128][16][16];
	static DATA_T O39_SW[256][8][8];
	static DATA_T O40_SW[256][8][8];
	static DATA_T O41_SW[256][8][8];
	static DATA_T O42_SW[256][8][8];
	static DATA_T O43_SW[256][8][8];
	static DATA_T O44_SW[256][8][8];
	static DATA_T O45_SW[256][8][8];
	static DATA_T O46_SW[256][8][8];
	static DATA_T O47_SW[256][8][8];
	static DATA_T O48_SW[256][8][8];
	static DATA_T O49_SW[256][8][8];
	static DATA_T O50_SW[256][8][8];
	static DATA_T O51_SW[256][8][8];
	static DATA_T O52_SW[256][8][8];
	static DATA_T O53_SW[256][8][8];
	static DATA_T O54_SW[256][8][8];
	static DATA_T O55_SW[256][8][8];
	static DATA_T O56_SW[256][8][8];
	static DATA_T O57_SW[256][8][8];
	static DATA_T O58_SW[256][8][8];
	static DATA_T O59_SW[256][8][8];
	static DATA_T O60_SW[256][8][8];
	static DATA_T O61_SW[256][8][8];
	static DATA_T O62_SW[256][8][8];
	static DATA_T O63_SW[256][8][8];
	static DATA_T O64_SW[256][8][8];
	static DATA_T O65_SW[256][8][8];
	static DATA_T O66_SW[256][8][8];
	static DATA_T O67_SW[256][8][8];
	static DATA_T O68_SW[256][8][8];
	static DATA_T O69_SW[256][8][8];
	static DATA_T O70_SW[512][4][4];
	static DATA_T O71_SW[512][4][4];
	static DATA_T O72_SW[512][4][4];
	static DATA_T O73_SW[512][4][4];
	static DATA_T O74_SW[512][4][4];
	static DATA_T O75_SW[512][4][4];
	static DATA_T O76_SW[512][4][4];
	static DATA_T O77_SW[512][4][4];
	static DATA_T O78_SW[512][4][4];
	static DATA_T O79_SW[512][4][4];
	static DATA_T O80_SW[512][4][4];
	static DATA_T O81_SW[512][4][4];
	static DATA_T O82_SW[512][4][4];
	static DATA_T O83_SW[512][4][4];
	static DATA_T O84_SW[512][4][4];
	static DATA_T O85_SW[512][4][4];
	static DATA_T O86_SW[512][4][4];
