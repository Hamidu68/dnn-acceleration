...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3 
 	...
 	Conv2D_2_x_loop: for (x=0; x<64+2; x++) {
 		Conv2D_2_y_loop: for (y=0; y<64+2; y++) {
...
//#pragma HLS ARRAY_PARTITION variable=I cyclic factor=3 dim=3
	...
	Pool_1_x_loop: for (x=0; x<64+2; x++) {
	  Pool_1_y_loop: for (y=0; y<64+2; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3 
 	...
 	Conv2D_3_x_loop: for (x=0; x<64+2; x++) {
 		Conv2D_3_y_loop: for (y=0; y<64+2; y++) {
...
#pragma HLS ARRAY_PARTITION variable=I complete dim=3 
 	...
 	Conv2D_4_x_loop: for (x=0; x<128+2; x++) {
 		Conv2D_4_y_loop: for (y=0; y<128+2; y++) {
...
//#pragma HLS ARRAY_PARTITION variable=I cyclic factor=3 dim=3
	...
	Pool_2_x_loop: for (x=0; x<128+2; x++) {
	  Pool_2_y_loop: for (y=0; y<128+2; y++) {
