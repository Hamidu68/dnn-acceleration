...
void Stream_output(hls::stream<DATA_T> &O_strm, DATA_T O[8][1][1]) {
  int m, x, y;
#pragma HLS ARRAY_PARTITION variable=O complete dim=1

	Stream_input_x_loop: for (x=0; x<1; x++) {
	 	Stream_input_y_loop: for (y=0; y<1; y++) {
#pragma HLS PIPELINE
	 		Stream_input_m_loop: for (m=0; m<8; m++) {
	 			O[m][x][y] = O_strm.read();
	    }
	  }
	}
...
void VGG19(DATA_T I[3][10][10], DATA_T I[3][10][10], DATA_T W1_i[4][3][3][3], DATA_T B1_i[4],DATA_T W3_i[8][4][3][3], DATA_T B3_i[8],DATA_T O[8][1][1] DATA_T O[8][1][1]) {
...
#pragma HLS ARRAY_PARTITION variable=W3_i complete dim=2
...
void VGG19_top(static DATA_T I[3][10][10];
...
W3_i_m_loop: for (m=0; m<8; m++) {
  ...
  VGG19(I_i, W1_i, B1_i, W3_i, B3_i, O_i);
...
void VGG19_sw(DATA_T I[3][10][10], DATA_T W1[4][3][3][3], DATA_T B1[4],DATA_T W3[8][4][3][3], DATA_T B3[8],DATA_T O6_SW[8][1][1]) {
...
void HW_block1_conv1(hls::stream<DATA_T> &I_strm, DATA_T W[4][3][3][3], DATA_T B[4], hls::stream<DATA_T> &O_strm) {
