...
int main(int argc, char *argv[]){
  ...
  SW_block1_conv1(O0_SW,O1_SW,B1,W1);
	...
	SW_fc2(O7_SW,W8,B8,O8_SW);
	SW_fc1000(O8_SW,W9,B9,O9_SW);
...
show_result= show_result + "Flatten" + " : [[";
for (k = 0; k <  8 ; k++) {
	show_result = show_result + " " + to_string((int)(O7_SW[k]));
}
show_result += "]]\n\n";

show_result= show_result + "Dense" + " : [[";
for (k = 0; k <  8 ; k++) {
	show_result = show_result + " " + to_string((int)(O8_SW[k]));
}
show_result += "]]\n\n";

show_result= show_result + "Dense" + " : [[";
for (k = 0; k <  3 ; k++) {
	show_result = show_result + " " + to_string((int)(O9_SW[k]));
}
show_result += "]]\n\n";
