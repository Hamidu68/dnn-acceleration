...
void Conv2D_padding_act_relu_1(DATA_T I[3][16][16], DATA_T W[8][3][3][3], DATA_T B[8], DATA_T O[8][16][16]) {
#pragma HLS INLINE
  int m, x, y, i, j, k;
  DATA_T ifm, ofm;
...
#pragma HLS DATAFLOW
  ...
  Conv2D_padding_act_relu_1(I_i, W1_i, B1_i, O1);
  Conv2D_padding_act_relu_2(O1, W2_i, B2_i, O2);
  MaxPooling2D_1(O2, O3);
  Conv2D_padding_act_relu_3(O3, W3_i, B3_i, O_i);
...
VGG16_top( I, W1, W2, W3, B1[8], B2, O);
