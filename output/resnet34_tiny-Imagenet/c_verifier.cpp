...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O47_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O47_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O48_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O48_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O49_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O49_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O50_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O50_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O51_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O51_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O52_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O52_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O53_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O53_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O54_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O54_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O55_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O55_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O56_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O56_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O57_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O57_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O58_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O58_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O59_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O59_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O60_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O60_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O61_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O61_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O62_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O62_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O63_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O63_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O64_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O64_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O65_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O65_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O66_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O66_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O67_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O67_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O68_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O68_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 8 ; k++) {
	...
	for (x = 0; x < 8 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 256 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O69_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O69_SW[y][k][x]);
		}
		if(x != 8 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O70_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O70_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O71_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O71_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O72_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O72_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O73_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O73_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O74_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O74_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O75_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O75_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O76_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O76_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O77_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O77_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O78_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O78_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O79_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O79_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O80_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O80_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O81_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O81_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O82_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O82_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O83_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O83_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O84_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O84_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O85_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O85_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k < 4 ; k++) {
	...
	for (x = 0; x < 4 ; x++) {
		fprintf(o_stream,"%s","[");
		for(y = 0; y < 512 ; y++) {
			fprintf(o_stream,"%.6f ",(float)O86_SW[y][k][x]);
			fprintf(c_num,"%.6f ",(float)O86_SW[y][k][x]);
		}
		if(x != 4 -1 )
			fprintf(o_stream,"%s","]\n   ");
		else
...
for (k = 0; k <  512 ; k++) {
	fprintf(o_stream,"%.6f ",(float)O87_SW[k]);
	fprintf(c_num,"%.6f ",(float)O87_SW[k]);
}
fprintf(o_stream,"%s","]]\n\n");
...
for (k = 0; k <  200 ; k++) {
	fprintf(o_stream,"%.6f ",(float)O88_SW[k]);
	fprintf(c_num,"%.6f ",(float)O88_SW[k]);
}
fprintf(o_stream,"%s","]]\n\n");
